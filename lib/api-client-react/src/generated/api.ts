...
export const getListGardenReservationsUrl = (params: ListGardenReservationsParams,) => {
  const normalizedParams = new URLSearchParams();
  ...
  return stringifiedParams.length > 0 ? `/api/garden/reservations?${stringifiedParams}` : `/api/garden/reservations`
}

/**
 * @summary List garden reservations for a week
 */
export const listGardenReservations = async (params: ListGardenReservationsParams, options?: RequestInit): Promise<GardenReservation[]> => {

  return customFetch<GardenReservation[]>(getListGardenReservationsUrl(params),
  {
    ...options,
    method: 'GET'
...
export const getListGardenReservationsQueryKey = (params?: ListGardenReservationsParams,) => {
    return [
    `/api/garden/reservations`, ...(params ? [params] : [])
    ] as const;
    }


export const getListGardenReservationsQueryOptions = <TData = Awaited<ReturnType<typeof listGardenReservations>>, TError = ErrorType<unknown>>(params: ListGardenReservationsParams, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof listGardenReservations>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {

const {query: queryOptions, request: requestOptions} = options ?? {};

  const queryKey =  queryOptions?.queryKey ?? getListGardenReservationsQueryKey(params);



    const queryFn: QueryFunction<Awaited<ReturnType<typeof listGardenReservations>>> = ({ signal }) => listGardenReservations(params, { signal, ...requestOptions });





   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof listGardenReservations>>, TError, TData> & { queryKey: QueryKey }
}
...
export function useListGardenReservations<TData = Awaited<ReturnType<typeof listGardenReservations>>, TError = ErrorType<unknown>>(
 params: ListGardenReservationsParams, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof listGardenReservations>>, TError, TData>, request?: SecondParameter<typeof customFetch>}

 ):  UseQueryResult<TData, TError> & { queryKey: QueryKey } {

  const queryOptions = getListGardenReservationsQueryOptions(params,options)
...
export const getCreateGardenReservationUrl = () => {




  return `/api/garden/reservations`
}

/**
 * @summary Reserve the garden table for an evening
 */
export const createGardenReservation = async (gardenReservationInput: GardenReservationInput, options?: RequestInit): Promise<GardenReservation> => {

  return customFetch<GardenReservation>(getCreateGardenReservationUrl(),
  {
    ...options,
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
...
export const getCreateGardenReservationMutationOptions = <TError = ErrorType<void>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof createGardenReservation>>, TError,{data: BodyType<GardenReservationInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof createGardenReservation>>, TError,{data: BodyType<GardenReservationInput>}, TContext> => {

const mutationKey = ['createGardenReservation'];
const {mutation: mutationOptions, request: requestOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof createGardenReservation>>, {data: BodyType<GardenReservationInput>}> = (props) => {
          const {data} = props ?? {};

          return  createGardenReservation(data,requestOptions)
        }
 ...
 * @summary Reserve the garden table for an evening
 */
export const useCreateGardenReservation = <TError = ErrorType<void>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof createGardenReservation>>, TError,{data: BodyType<GardenReservationInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
        Awaited<ReturnType<typeof createGardenReservation>>,
        TError,
...
export const getDeleteGardenReservationUrl = (id: number,) => {
  ...
  return `/api/garden/reservations/${id}`
}

/**
 * @summary Cancel a reservation
 */
export const deleteGardenReservation = async (id: number, options?: RequestInit): Promise<void> => {

  return customFetch<void>(getDeleteGardenReservationUrl(id),
  {
    ...options,
    method: 'DELETE'
...
export const getDeleteGardenReservationMutationOptions = <TError = ErrorType<void>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof deleteGardenReservation>>, TError,{id: number}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof deleteGardenReservation>>, TError,{id: number}, TContext> => {

const mutationKey = ['deleteGardenReservation'];
const {mutation: mutationOptions, request: requestOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof deleteGardenReservation>>, {id: number}> = (props) => {
          const {id} = props ?? {};

          return  deleteGardenReservation(id,requestOptions)
        }
 ...
 * @summary Cancel a reservation
 */
export const useDeleteGardenReservation = <TError = ErrorType<void>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof deleteGardenReservation>>, TError,{id: number}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
        Awaited<ReturnType<typeof deleteGardenReservation>>,
        TError,
        {id: number},
        TContext
      > => {
      return useMutation(getDeleteGardenReservationMutationOptions(options));
    }
